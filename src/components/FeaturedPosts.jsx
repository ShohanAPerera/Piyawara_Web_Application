        ...
        <div className='mt-8 flex flex-col lg:flex-row gap-8'>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                ...
                <div className="lg:h-1/3 flex justify-between gap-4 ">
                    ...
                    <div className="w-2/3">
                        {/*Details*/}
                        <div className="flex items-center gap-4 tex-sm lg:text-base mb-4">
                            <h1 className="font-semibold">02.</h1>
                            <Link className="text-blue-800">Web Design</Link>
                            <span className="text-gray-500 text-sm">2 days Ago</span>
                        </div>
                        {/*titles*/}
                        <Link to="/test" className="text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium" >Lorem, ipsum dolor sit amet consectetur adpicingn elit </Link>
